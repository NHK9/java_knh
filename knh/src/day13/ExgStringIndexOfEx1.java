...
public class ExgStringIndexOfEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 몇번지에 있는지 알려주는 메소드 없으면 -1
		 * int indexOf(String str, String from): from 번지부터 검색하여
		 * str이 몇번지에서 시작하는지 알려주는 메소로 없으면 -1
		 * int lastIndexOf(int ch) : 마지막번지부터 검색해서 몇번지에있는지
		 * 알려주는 메소드 없으면 -1
		 */
		...
		System.out.println((char)ch +"의갯수 :" + count);
