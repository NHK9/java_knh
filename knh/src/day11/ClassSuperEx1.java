...
class Child1 extends parent1{
	 ...
	 * setter를 이용해서 할수있지만, setter를 이용하는것보다
	 * 부모클래스에 있는 생성자를 이용하는게 편하다*/
		//setX(x); setY(y);
		super(x, y);
		this.z=z;
	}
	/* 클래스 안에 멤버변수, 메소드, 생성자가 하나도 없으면
	 * 자동으로 기본 생성자가 생성되고,
	 * 기본 생성자 안에 부모 클래스의 기본 생성자가 호출된다.
	 * 이때, 부모 클래스의 기본 생성자가 없는경우 호출할 수 없어서 에러발생
	 */
	/*public child1() {
		super();
	}*/
	@Override
	public void print() {
		//부모에 있는 프린트를 이용해서 x,y를 출력하고 뒷부분은 직접 출력
		super.print();
